...
export const clubs: Club[] = [
  { name: "Cybersecurity Club", focus: "Cybersecurity", members: 64, accent: "teal" },
  { name: "Innovation Club", focus: "Innovation and development", members: 51, accent: "blue" },
  { name: "AI Club", focus: "Artificial intelligence", members: 47, accent: "violet" },
  { name: "Social Impact Club", focus: "Social entrepreneurship", members: 42, accent: "amber" },
  { name: "Tech Community", focus: "Technology community", members: 39, accent: "green" },
  { name: "Chess Club", focus: "Chess and strategy", members: 25, accent: "slate" },
  { name: "Student Life Club", focus: "Student life", members: 30, accent: "rose" },
  { name: "Tech Workshop Club", focus: "IT workshops and group learning", members: 58, accent: "cyan" },
  { name: "Music Club", focus: "Music and campus culture", members: 34, accent: "orange" },
];
